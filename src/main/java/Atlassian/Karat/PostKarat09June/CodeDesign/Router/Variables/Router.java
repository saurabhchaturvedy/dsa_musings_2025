package PostKarat09June.CodeDesign.Router.Variables;
...
public class Router {
    ...
    static class RouteBuilder {
        ...
        public RouteBuilder withRoute(String pattern, String result) {


            if (pattern.contains(":") || pattern.contains("*")) {

                wildCardRoutes.add(new WildCardRoute(pattern, result));
            } else {

                staticRoutes.put(pattern, result);
            }
