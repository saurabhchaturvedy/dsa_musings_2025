...
public class FileCollectionSystem {
    ...
    public void addFile(String name, Integer size, List<String> collections) {
        ...
        if (collections != null) {
            ...
            for (String collection : collections) {
                ...
                Collection collectionToAddTo = this.collections.computeIfAbsent(collection, Collection::new);
    ...
    public List<Collection> topK(int k) {
        ...
        PriorityQueue<Collection> minHeap = new PriorityQueue<>(
                ...
                (a, b) -> {
                    ...
                    Integer sizeCompare = a.getTotalSize() - a.getTotalSize();
                    if (sizeCompare != 0) {
                        return sizeCompare;
                    }
    ...
    public static void main(String[] args) {
        ...
        List<Collection> collectionList = fileCollectionSystem.topK(3);
