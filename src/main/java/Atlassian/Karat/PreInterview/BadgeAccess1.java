...
public class BadgeAccess1 {
    ...
    public static Map<String, Set<String>> badgeAccess1(List<String[]> accessLog) {
        ...
        Set<String> exitWithoutAnEnter = new HashSet<>();
        ...
        result.put("exitWithoutAnEnter", exitWithoutAnEnter);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Exited without entering: " + result.get("exitWithoutAnEnter"));
    }
}
